...
public class Menu extends Thread {
	...
	public void run() {
		...
		for (int i = 0; i < nFrame; i++) {
			...
			switch (i) {
				case 0:
					panel[0].paintImgMenu(-300, -100, 1050, 900,"LogoConGriglia");
					break;
				case 1:
					panel[1].paintImgMenu(0, 0, 1050, 900,"LogoConGriglia");
					break;
				case 2:
					panel[2].paintImgMenu(-192, -450, 1050, 900,"LogoConGriglia");
					break;
				case 3:
					panel[3].paintImgMenu(-750, -200, 1050, 900,"LogoConGriglia");
					break;
				case 4:
					panel[4].paintImgMenu(0, 0, 300, 100,"scoreboard");
					break;
				case 5:
					panel[5].paintImgMenu(-10, -10, 320, 120,"play");
					break;
				case 6:
					panel[6].paintImgMenu(0, 0, 300, 100,"settings");
					break;
			}
			try {
				Thread.sleep(DELAY);
