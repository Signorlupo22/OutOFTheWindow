...
public class LevelInfo {
	...
	///ci sarà un costruttore con tutte le varie info (numero di shell)
	...
	public LevelInfo() { ///costruttore di default
		...
		panel = new GamePanel[shellCount]; ///grafica delle shell (Thomas dice motore grafico e io sorrideò e annuirò senza capire)
